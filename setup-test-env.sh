...
# the @anirudhtx/aave-v3-deploy-pyth package as source of deployment
...
# required by @anirudhtx/aave-v3-deploy-pyth hardhat plugin due hardhat package.json resolution
...
cp -r node_modules/@anirudhtx/aave-v3-deploy-pyth/artifacts/contracts/* temp-artifacts/deploy
cp -r 'node_modules/@anirudhtx/aave-v3-deploy-pyth/artifacts/@aave/safety-module/contracts/stake' temp-artifacts/deploy
cp -r 'node_modules/@anirudhtx/aave-v3-deploy-pyth/artifacts/@aave/safety-module/contracts/proposals' temp-artifacts/deploy/stake
